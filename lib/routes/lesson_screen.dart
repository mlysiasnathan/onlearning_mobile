                      ...
                      builder: (ctx, coursesData, child) {
                        return Column(
                          ...
                          children: [
                            ...
                            if (coursesData.documents.isNotEmpty)
                              SizedBox(
                                // height: 60,
                                height: min(
                            ...
                            if (coursesData.videos.isNotEmpty)
                              SizedBox(
                                height: 400,
                                // height: min(coursesData.videos.length * 19.0 + 10, 100),
                                child: ListView.builder(
                                  padding: const EdgeInsets.all(10),
                                  // physics: const NeverScrollableScrollPhysics(),
